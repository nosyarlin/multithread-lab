    	...
    	\begin{figure}[H]
	    	\begin{tikzpicture}
	  		\begin{axis}[
			    ...
			    \addplot [color=red, mark=square]coordinates {(1,2.742)(2,2.747)(4,3.809)(8,3.819)(16,4.069)(32,5.152)(64,5.34)(128,6.151)(512,13.127)(1024,22.221)(2048,42.229)};
			\end{axis}  
			\end{tikzpicture}
    	...
    	\begin{figure}[H]
	    	\begin{tikzpicture}
	  		\begin{axis}[
			    ...
			    \addplot [color=red, mark=square]coordinates {(1,200.005)(2,210.683)(4,258.087)(8,289.732)(16,303.855)(32,335.455)(64,404.053)(128,565.813)(512,1529.267)(1024,2847.666)(2048,5511.868)};
			\end{axis}  
			\end{tikzpicture}
			\caption{Scatter plot of results}
    	\end{figure}
